...
void PrintfInfo(void)
{
	...
	#elif defined (M2006_MOTOR_MEASURE)  /*打印底盘3508电机的信息*/
        printf("\n\r The motor angle and speed_rpm is:%d  %d\n\r", Pluck_Motor[0].angle, Pluck_Motor[0].speed_rpm);  //打印电机的转子机械角度和转子转度
        printf("\n\r The motor current is:%f\n\r", Pluck_Motor[0].real_current);  //打印电机转矩电流
	
    #elif defined (M6020_MOTOR_MEASURE)  /*打印云台6020电机的信息*/
        printf("\n\r The motor offset_angle and total_angle is:%d  %d\n\r",Gimbal_Motor[1].offset_angle, Gimbal_Motor[1].angle);  //打印电机的转子机械角度和转子转度
